...
public class _BufferStub extends org.omg.CORBA.portable.ObjectImpl implements BufferApp.Buffer
{
  ...
  public int getNewsLength ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getNewsLength", true);
                $in = _invoke ($out);
  ...
  public int getMaxNews ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getMaxNews", true);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public boolean fijarLimiteNoticias (int numeroMaximo)
  {
            ...
            try {
                ...
                return fijarLimiteNoticias (numeroMaximo        );
            } finally {
                _releaseReply ($in);
            }
  } // fijarLimiteNoticias
